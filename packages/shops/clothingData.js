...
// Экспорт функции получения torso
function getBestTorso(topDrawable, gender = 0) {
    if (gender === 0) { // Male
        return MALE_BEST_TORSO[topDrawable] !== undefined ? MALE_BEST_TORSO[topDrawable] : 0;
    }
    // Для женской модели можно добавить отдельный объект
    return 0;
}
